...
| **Nudgeless lane change** | Lane change without a nudge once the blinker is on (timed hold). | Reduces the hand-torque ritual on long highway drives. | `NudgelessLaneChange` | 🟡 | 2026-06-22 |
